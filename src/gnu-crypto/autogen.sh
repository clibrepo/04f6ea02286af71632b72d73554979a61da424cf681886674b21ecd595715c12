#!/bin/sh
# ----------------------------------------------------------------------------
# $Id: autogen.sh,v 1.1 2002/11/25 12:46:36 raif Exp $
#
...
[ -f configure.ac ] || {
   echo "*** Info: You should run this command at the top of the GNU Crypto"
   echo "project, or in a build directory after invoking the 'init.sh' script."
   exit 1
}
...
echo "*** Info: Generating GNU build toolchain scripts and files for GNU Crypto."
