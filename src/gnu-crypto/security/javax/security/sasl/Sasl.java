...
// ----------------------------------------------------------------------------
// $Id: Sasl.java,v 1.1 2003/05/10 18:45:12 raif Exp $
//
         ...
         for (j = 0; j < providers.length; j++) {
            ...
            if (p != null) {
               ...
               try {
                  ...
                  result = factory.createSaslClient(
                        mechanisms, authorizationID, protocol, serverName, props, cbh);
      ...
      for (j = 0; j < providers.length; j++) {
         ...
         if (p != null) {
            ...
            try {
               ...
               result = factory.createSaslServer(
