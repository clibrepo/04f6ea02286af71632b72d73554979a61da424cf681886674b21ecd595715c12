...
// ----------------------------------------------------------------------------
// $Id: PasswordFile.java,v 1.2 2003/12/25 01:59:44 uid66198 Exp $
//
...
public class PasswordFile {
   ...
   add(final String user, final String passwd, final String[] attributes)
   throws IOException {
