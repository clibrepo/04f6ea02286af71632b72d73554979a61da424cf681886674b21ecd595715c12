...
// ----------------------------------------------------------------------------
// $Id: Serpent.java,v 1.8 2003/04/28 10:32:36 raif Exp $
//
...
public class Serpent extends BaseCipher {
   ...
   public Object makeKey(byte[] kb, int blockSize) throws InvalidKeyException {
      ...
      key.k0 = x0; key.k1 = x1; key.k2 = x2; key.k3 = x3;
      sbox2(w[4], w[5], w[6], w[7]);
      key.k4 = x0; key.k5 = x1; key.k6 = x2; key.k7 = x3;
      sbox1(w[8], w[9], w[10], w[11]);
      key.k8 = x0; key.k9 = x1; key.k10 = x2; key.k11 = x3;
      sbox0(w[12], w[13], w[14], w[15]);
      key.k12 = x0; key.k13 = x1; key.k14 = x2; key.k15 = x3;
      sbox7(w[16], w[17], w[18], w[19]);
      key.k16 = x0; key.k17 = x1; key.k18 = x2; key.k19 = x3;
      sbox6(w[20], w[21], w[22], w[23]);
      key.k20 = x0; key.k21 = x1; key.k22 = x2; key.k23 = x3;
      sbox5(w[24], w[25], w[26], w[27]);
      key.k24 = x0; key.k25 = x1; key.k26 = x2; key.k27 = x3;
      sbox4(w[28], w[29], w[30], w[31]);
      key.k28 = x0; key.k29 = x1; key.k30 = x2; key.k31 = x3;
      sbox3(w[32], w[33], w[34], w[35]);
      key.k32 = x0; key.k33 = x1; key.k34 = x2; key.k35 = x3;
      sbox2(w[36], w[37], w[38], w[39]);
      key.k36 = x0; key.k37 = x1; key.k38 = x2; key.k39 = x3;
      sbox1(w[40], w[41], w[42], w[43]);
      key.k40 = x0; key.k41 = x1; key.k42 = x2; key.k43 = x3;
      sbox0(w[44], w[45], w[46], w[47]);
      key.k44 = x0; key.k45 = x1; key.k46 = x2; key.k47 = x3;
      sbox7(w[48], w[49], w[50], w[51]);
      key.k48 = x0; key.k49 = x1; key.k50 = x2; key.k51 = x3;
      sbox6(w[52], w[53], w[54], w[55]);
      key.k52 = x0; key.k53 = x1; key.k54 = x2; key.k55 = x3;
      sbox5(w[56], w[57], w[58], w[59]);
      key.k56 = x0; key.k57 = x1; key.k58 = x2; key.k59 = x3;
      sbox4(w[60], w[61], w[62], w[63]);
      key.k60 = x0; key.k61 = x1; key.k62 = x2; key.k63 = x3;
      sbox3(w[64], w[65], w[66], w[67]);
      key.k64 = x0; key.k65 = x1; key.k66 = x2; key.k67 = x3;
      sbox2(w[68], w[69], w[70], w[71]);
      key.k68 = x0; key.k69 = x1; key.k70 = x2; key.k71 = x3;
      sbox1(w[72], w[73], w[74], w[75]);
      key.k72 = x0; key.k73 = x1; key.k74 = x2; key.k75 = x3;
      sbox0(w[76], w[77], w[78], w[79]);
      key.k76 = x0; key.k77 = x1; key.k78 = x2; key.k79 = x3;
      sbox7(w[80], w[81], w[82], w[83]);
      key.k80 = x0; key.k81 = x1; key.k82 = x2; key.k83 = x3;
      sbox6(w[84], w[85], w[86], w[87]);
      key.k84 = x0; key.k85 = x1; key.k86 = x2; key.k87 = x3;
      sbox5(w[88], w[89], w[90], w[91]);
      key.k88 = x0; key.k89 = x1; key.k90 = x2; key.k91 = x3;
      sbox4(w[92], w[93], w[94], w[95]);
      key.k92 = x0; key.k93 = x1; key.k94 = x2; key.k95 = x3;
      sbox3(w[96], w[97], w[98], w[99]);
      key.k96 = x0; key.k97 = x1; key.k98 = x2; key.k99 = x3;
      sbox2(w[100], w[101], w[102], w[103]);
      key.k100 = x0; key.k101 = x1; key.k102 = x2; key.k103 = x3;
      sbox1(w[104], w[105], w[106], w[107]);
      key.k104 = x0; key.k105 = x1; key.k106 = x2; key.k107 = x3;
      sbox0(w[108], w[109], w[110], w[111]);
      key.k108 = x0; key.k109 = x1; key.k110 = x2; key.k111 = x3;
      sbox7(w[112], w[113], w[114], w[115]);
      key.k112 = x0; key.k113 = x1; key.k114 = x2; key.k115 = x3;
      sbox6(w[116], w[117], w[118], w[119]);
      key.k116 = x0; key.k117 = x1; key.k118 = x2; key.k119 = x3;
      sbox5(w[120], w[121], w[122], w[123]);
      key.k120 = x0; key.k121 = x1; key.k122 = x2; key.k123 = x3;
      sbox4(w[124], w[125], w[126], w[127]);
      key.k124 = x0; key.k125 = x1; key.k126 = x2; key.k127 = x3;
      sbox3(w[128], w[129], w[130], w[131]);
      key.k128 = x0; key.k129 = x1; key.k130 = x2; key.k131 = x3;
   ...
   encrypt(byte[] in, int i, byte[] out, int o, Object K, int bs) {
      ...
      x0 = (in[i   ] & 0xff)       | (in[i+ 1] & 0xff) <<  8 |
           (in[i+ 2] & 0xff) << 16 | (in[i+ 3] & 0xff) << 24;
      ...
      x0 ^= key.k0; x1 ^= key.k1; x2 ^= key.k2; x3 ^= key.k3; sbox0();
      x1 ^= key.k4; x4 ^= key.k5; x2 ^= key.k6; x0 ^= key.k7; sbox1();
      x0 ^= key.k8; x4 ^= key.k9; x2 ^= key.k10; x1 ^= key.k11; sbox2();
      x2 ^= key.k12; x1 ^= key.k13; x4 ^= key.k14; x3 ^= key.k15; sbox3();
      x1 ^= key.k16; x4 ^= key.k17; x3 ^= key.k18; x0 ^= key.k19; sbox4();
      x4 ^= key.k20; x2 ^= key.k21; x1 ^= key.k22; x0 ^= key.k23; sbox5();
      x2 ^= key.k24; x0 ^= key.k25; x4 ^= key.k26; x1 ^= key.k27; sbox6();
      x2 ^= key.k28; x0 ^= key.k29; x3 ^= key.k30; x4 ^= key.k31; sbox7();
      x0 = x3; x3 = x2; x2 = x4;

      x0 ^= key.k32; x1 ^= key.k33; x2 ^= key.k34; x3 ^= key.k35; sbox0();
      x1 ^= key.k36; x4 ^= key.k37; x2 ^= key.k38; x0 ^= key.k39; sbox1();
      x0 ^= key.k40; x4 ^= key.k41; x2 ^= key.k42; x1 ^= key.k43; sbox2();
      x2 ^= key.k44; x1 ^= key.k45; x4 ^= key.k46; x3 ^= key.k47; sbox3();
      x1 ^= key.k48; x4 ^= key.k49; x3 ^= key.k50; x0 ^= key.k51; sbox4();
      x4 ^= key.k52; x2 ^= key.k53; x1 ^= key.k54; x0 ^= key.k55; sbox5();
      x2 ^= key.k56; x0 ^= key.k57; x4 ^= key.k58; x1 ^= key.k59; sbox6();
      x2 ^= key.k60; x0 ^= key.k61; x3 ^= key.k62; x4 ^= key.k63; sbox7();
      x0 = x3; x3 = x2; x2 = x4;

      x0 ^= key.k64; x1 ^= key.k65; x2 ^= key.k66; x3 ^= key.k67; sbox0();
      x1 ^= key.k68; x4 ^= key.k69; x2 ^= key.k70; x0 ^= key.k71; sbox1();
      x0 ^= key.k72; x4 ^= key.k73; x2 ^= key.k74; x1 ^= key.k75; sbox2();
      x2 ^= key.k76; x1 ^= key.k77; x4 ^= key.k78; x3 ^= key.k79; sbox3();
      x1 ^= key.k80; x4 ^= key.k81; x3 ^= key.k82; x0 ^= key.k83; sbox4();
      x4 ^= key.k84; x2 ^= key.k85; x1 ^= key.k86; x0 ^= key.k87; sbox5();
      x2 ^= key.k88; x0 ^= key.k89; x4 ^= key.k90; x1 ^= key.k91; sbox6();
      x2 ^= key.k92; x0 ^= key.k93; x3 ^= key.k94; x4 ^= key.k95; sbox7();
      x0 = x3; x3 = x2; x2 = x4;

      x0 ^= key.k96; x1 ^= key.k97; x2 ^= key.k98; x3 ^= key.k99; sbox0();
      x1 ^= key.k100; x4 ^= key.k101; x2 ^= key.k102; x0 ^= key.k103; sbox1();
      x0 ^= key.k104; x4 ^= key.k105; x2 ^= key.k106; x1 ^= key.k107; sbox2();
      x2 ^= key.k108; x1 ^= key.k109; x4 ^= key.k110; x3 ^= key.k111; sbox3();
      x1 ^= key.k112; x4 ^= key.k113; x3 ^= key.k114; x0 ^= key.k115; sbox4();
      x4 ^= key.k116; x2 ^= key.k117; x1 ^= key.k118; x0 ^= key.k119; sbox5();
      x2 ^= key.k120; x0 ^= key.k121; x4 ^= key.k122; x1 ^= key.k123; sbox6();
      x2 ^= key.k124; x0 ^= key.k125; x3 ^= key.k126; x4 ^= key.k127; sbox7noLT();
      x0 = x3; x3 = x2; x2 = x4;
      x0 ^= key.k128; x1 ^= key.k129; x2 ^= key.k130; x3 ^= key.k131;
   ...
   decrypt(byte[] in, int i, byte[] out, int o, Object K, int bs) {
      ...
      x0 ^= key.k128; x1 ^= key.k129; x2 ^= key.k130; x3 ^= key.k131; sboxI7noLT();
      x3 ^= key.k124; x0 ^= key.k125; x1 ^= key.k126; x4 ^= key.k127; sboxI6();
      x0 ^= key.k120; x1 ^= key.k121; x2 ^= key.k122; x4 ^= key.k123; sboxI5();
      x1 ^= key.k116; x3 ^= key.k117; x4 ^= key.k118; x2 ^= key.k119; sboxI4();
      x1 ^= key.k112; x2 ^= key.k113; x4 ^= key.k114; x0 ^= key.k115; sboxI3();
      x0 ^= key.k108; x1 ^= key.k109; x4 ^= key.k110; x2 ^= key.k111; sboxI2();
      x1 ^= key.k104; x3 ^= key.k105; x4 ^= key.k106; x2 ^= key.k107; sboxI1();
      x0 ^= key.k100; x1 ^= key.k101; x2 ^= key.k102; x4 ^= key.k103; sboxI0();
      x0 ^= key.k96; x3 ^= key.k97; x1 ^= key.k98; x4 ^= key.k99; sboxI7();
      x1 = x3; x3 = x4; x4 = x2;

      x3 ^= key.k92; x0 ^= key.k93; x1 ^= key.k94; x4 ^= key.k95; sboxI6();
      x0 ^= key.k88; x1 ^= key.k89; x2 ^= key.k90; x4 ^= key.k91; sboxI5();
      x1 ^= key.k84; x3 ^= key.k85; x4 ^= key.k86; x2 ^= key.k87; sboxI4();
      x1 ^= key.k80; x2 ^= key.k81; x4 ^= key.k82; x0 ^= key.k83; sboxI3();
      x0 ^= key.k76; x1 ^= key.k77; x4 ^= key.k78; x2 ^= key.k79; sboxI2();
      x1 ^= key.k72; x3 ^= key.k73; x4 ^= key.k74; x2 ^= key.k75; sboxI1();
      x0 ^= key.k68; x1 ^= key.k69; x2 ^= key.k70; x4 ^= key.k71; sboxI0();
      x0 ^= key.k64; x3 ^= key.k65; x1 ^= key.k66; x4 ^= key.k67; sboxI7();
      x1 = x3; x3 = x4; x4 = x2;

      x3 ^= key.k60; x0 ^= key.k61; x1 ^= key.k62; x4 ^= key.k63; sboxI6();
      x0 ^= key.k56; x1 ^= key.k57; x2 ^= key.k58; x4 ^= key.k59; sboxI5();
      x1 ^= key.k52; x3 ^= key.k53; x4 ^= key.k54; x2 ^= key.k55; sboxI4();
      x1 ^= key.k48; x2 ^= key.k49; x4 ^= key.k50; x0 ^= key.k51; sboxI3();
      x0 ^= key.k44; x1 ^= key.k45; x4 ^= key.k46; x2 ^= key.k47; sboxI2();
      x1 ^= key.k40; x3 ^= key.k41; x4 ^= key.k42; x2 ^= key.k43; sboxI1();
      x0 ^= key.k36; x1 ^= key.k37; x2 ^= key.k38; x4 ^= key.k39; sboxI0();
      x0 ^= key.k32; x3 ^= key.k33; x1 ^= key.k34; x4 ^= key.k35; sboxI7();
      x1 = x3; x3 = x4; x4 = x2;

      x3 ^= key.k28; x0 ^= key.k29; x1 ^= key.k30; x4 ^= key.k31; sboxI6();
      x0 ^= key.k24; x1 ^= key.k25; x2 ^= key.k26; x4 ^= key.k27; sboxI5();
      x1 ^= key.k20; x3 ^= key.k21; x4 ^= key.k22; x2 ^= key.k23; sboxI4();
      x1 ^= key.k16; x2 ^= key.k17; x4 ^= key.k18; x0 ^= key.k19; sboxI3();
      x0 ^= key.k12; x1 ^= key.k13; x4 ^= key.k14; x2 ^= key.k15; sboxI2();
      x1 ^= key.k8; x3 ^= key.k9; x4 ^= key.k10; x2 ^= key.k11; sboxI1();
      x0 ^= key.k4; x1 ^= key.k5; x2 ^= key.k6; x4 ^= key.k7; sboxI0();
      x2 = x1; x1 = x3; x3 = x4;

      x0 ^= key.k0; x1 ^= key.k1; x2 ^= key.k2; x3 ^= key.k3;
...
 // These S-Box functions are used in the key setup.
   ...
   private class Key implements Cloneable {
      ...
      int k0, k1, k2, k3, k4, k5, k6, k7, k8, k9, k10, k11, k12, k13,
