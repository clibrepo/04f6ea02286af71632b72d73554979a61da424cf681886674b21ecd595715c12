...
// ----------------------------------------------------------------------------
// $Id: Cast5.java,v 1.2 2003/06/21 09:13:03 raif Exp $
//
...
public class Cast5 extends BaseCipher {
   ...
   public void encrypt(byte[] in, int i, byte[] out, int j, Object k, int bs) {
      ...
      int L = (in[i++] & 0xFF) << 24 | (in[i++] & 0xFF) << 16 | (in[i++] & 0xFF) << 8 | in[i++] & 0xFF;
      int R = (in[i++] & 0xFF) << 24 | (in[i++] & 0xFF) << 16 | (in[i++] & 0xFF) << 8 | in[i  ] & 0xFF;

      L ^= f1(R, K.Km0,  K.Kr0 ); R ^= f2(L, K.Km1,  K.Kr1);     // round 2
      L ^= f3(R, K.Km2,  K.Kr2 ); R ^= f1(L, K.Km3,  K.Kr3);     // round 4
      L ^= f2(R, K.Km4,  K.Kr4 ); R ^= f3(L, K.Km5,  K.Kr5);     // round 6
      L ^= f1(R, K.Km6,  K.Kr6 ); R ^= f2(L, K.Km7,  K.Kr7);     // round 8
      L ^= f3(R, K.Km8,  K.Kr8 ); R ^= f1(L, K.Km9,  K.Kr9);     // round 10
      L ^= f2(R, K.Km10, K.Kr10); R ^= f3(L, K.Km11, K.Kr11);    // round 12
      if (K.rounds == _16_ROUNDS) {
         L ^= f1(R, K.Km12, K.Kr12); R ^= f2(L, K.Km13, K.Kr13); // round 14
         L ^= f3(R, K.Km14, K.Kr14); R ^= f1(L, K.Km15, K.Kr15); // round 16
      }
   ...
   public void decrypt(byte[] in, int i, byte[] out, int j, Object k, int bs) {
      ...
      if (K.rounds == _16_ROUNDS) {
         L ^= f1(R, K.Km15, K.Kr15); R ^= f3(L, K.Km14, K.Kr14);
         L ^= f2(R, K.Km13, K.Kr13); R ^= f1(L, K.Km12, K.Kr12);
      }
      L ^= f3(R, K.Km11, K.Kr11); R ^= f2(L, K.Km10, K.Kr10);
      L ^= f1(R, K.Km9,  K.Kr9 ); R ^= f3(L, K.Km8,  K.Kr8);
      L ^= f2(R, K.Km7,  K.Kr7 ); R ^= f1(L, K.Km6,  K.Kr6);
      L ^= f3(R, K.Km5,  K.Kr5 ); R ^= f2(L, K.Km4,  K.Kr4);
      L ^= f1(R, K.Km3,  K.Kr3 ); R ^= f3(L, K.Km2,  K.Kr2);
      L ^= f2(R, K.Km1,  K.Kr1 ); R ^= f1(L, K.Km0,  K.Kr0);
   ...
   private class Cast5Key {
      ...
      int Kr0, Kr1, Kr2, Kr3, Kr4, Kr5, Kr6, Kr7, Kr8, Kr9, Kr10, Kr11, Kr12, Kr13, Kr14, Kr15;
   }
}
