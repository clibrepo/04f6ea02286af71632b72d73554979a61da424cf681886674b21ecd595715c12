...
// ----------------------------------------------------------------------------
// $Id: TestOfPRNGFactory.java,v 1.1 2002/12/19 09:29:55 raif Exp $
//
   ...
   public void test(TestHarness harness) {
      ...
      for (Iterator it = PRNGFactory.getNames().iterator(); it.hasNext(); ) {
         ...
         try {
            ...
            harness.check(algorithm != null, "getInstance("+String.valueOf(prng)+")");
         } catch (InternalError x) {
            harness.fail("TestOfPRNGFactory.getInstance("+String.valueOf(prng)+")");
         }
      }
   }
}
