...
// ----------------------------------------------------------------------------
// $Id: TestOfSignatureFactory.java,v 1.1 2002/12/19 09:29:55 raif Exp $
//
...
/**
 * <p>Conformance tests for the SignatureFactory implementation.</p>
 *
   ...
   public void test(TestHarness harness) {
      ...
      for (Iterator it = SignatureFactory.getNames().iterator(); it.hasNext(); ) {
         ...
         try {
            ...
            harness.check(algorithm != null, "getInstance("+String.valueOf(scheme)+")");
         } catch (RuntimeException x) {
            harness.debug(x);
            harness.fail("TestOfSignatureFactory.getInstance("+String.valueOf(scheme)+")");
         }
      }
   }
}
