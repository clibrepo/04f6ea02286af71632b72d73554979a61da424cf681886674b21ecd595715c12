...
// ----------------------------------------------------------------------------
// $Id: TestOfKeyPairGeneratorFactory.java,v 1.1 2003/09/27 00:09:35 raif Exp $
//
...
/**
 * <p>Conformance tests for the KeyPairGeneratorFactory implementation.</p>
 *
   ...
   public void test(TestHarness harness) {
      ...
      for (Iterator it = KeyPairGeneratorFactory.getNames().iterator(); it.hasNext(); ) {
         ...
         try {
            ...
            harness.check(algorithm != null, "getInstance("+String.valueOf(kpg)+")");
         } catch (RuntimeException x) {
            harness.debug(x);
            harness.fail("TestOfKeyPairGeneratorFactory.getInstance("+String.valueOf(kpg)+")");
         }
      }
   }
}
